        ...
        <section className="relative pt-48 pb-16 px-6 md:px-10 bg-[#0a1628] overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none pointer-events-none">
            <svg viewBox="0 0 1440 90" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" className="w-full h-16 md:h-24">
              <path d="M0,30 C240,90 480,0 720,45 C960,90 1200,10 1440,50 L1440,90 L0,90 Z" fill="white" opacity="0.3" />
              <path d="M0,50 C200,10 440,80 720,35 C1000,0 1240,70 1440,40 L1440,90 L0,90 Z" fill="white" opacity="0.6" />
              <path d="M0,65 C180,30 400,75 660,55 C900,35 1200,75 1440,60 L1440,90 L0,90 Z" fill="white" />
            </svg>
          </div>
        </section>
        ...
        <section className="pb-24 px-6 md:px-10 pt-14">
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">
            ...
            <div className="w-full lg:w-2/3 min-w-0">
              ...
              {/* DESCRIPTION */}
              <p
                className="text-base text-gray-600 leading-relaxed whitespace-pre-wrap w-full"
