      ...
      <main className="bg-white min-h-screen">
        ...
        <section className="pb-24 px-6 md:px-10 relative">
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-start">
            ...
            {/* Main Content (Kiri) */}
            <div className="w-full lg:w-2/3 -mt-20 relative z-20 min-w-0">
              ...
              <div className="py-12">
                ...
                <p className="text-base text-slate-500 leading-relaxed whitespace-pre-wrap w-full text-justify overflow-wrap-normal break-normal">
                  {product.description || ""}
                </p>
