        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-xs leading-relaxed max-w-xs font-medium">
              {data?.description ||
                "Digital creative studio yang berdedikasi untuk mentransformasi ide Anda menjadi mahakarya visual."}
            </p>
            <div className="flex gap-3">
              <Link
                href="#"
                className="p-2.5 bg-white/5 rounded-lg hover:bg-cyan-500 transition-colors"
              >
                <Instagram size={16} />
              </Link>
              <Link
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-xs text-gray-400 font-medium">
                  {process.env.NEXT_PUBLIC_COMPANY_ADDRESS ||
                    "Jl. Creative Mukraf No. 26, Indonesia"}
                </p>
              </div>
